...
ET.data$EC.mean=(ET.data$ET_orig+ET.data$ET_closed)/2
ET.data$EC.range=abs((ET.data$ET_orig-ET.data$ET_closed)/2)

# Method A
ET.A.df=data.frame(date=ET.data$date, ET.A=ET.data$ET.A, 
                   ET.original=ET.data$ET_orig, ET.closed=ET.data$ET_closed)
